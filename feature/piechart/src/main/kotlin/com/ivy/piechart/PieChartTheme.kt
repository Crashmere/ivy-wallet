...
internal object PieChartTheme {
    ...
    val typo: PieChartTypography = pieChartTypography()
    val shapes: PieChartShapes = pieChartShapes()
}

internal interface PieChartColors {
    val pure: Color
...
internal interface PieChartTypography {
    val b1: TextStyle
    val b2: TextStyle
    val nB2: TextStyle
}

internal interface PieChartShapes {
...
private fun pieChartColors(
    theme: Theme,
    isDarkModeEnabled: Boolean,
): PieChartColors {
    return when (theme) {
        Theme.LIGHT -> object : PieChartColors {
        ...
        Theme.DARK -> object : PieChartColors {
        ...
        Theme.AMOLED_DARK -> object : PieChartColors {
        ...
        Theme.AUTO -> if (isDarkModeEnabled) {
            pieChartColors(Theme.DARK, true)
        } else {
            pieChartColors(Theme.LIGHT, false)
        }
    }
}

private fun pieChartTypography(): PieChartTypography {
    ...
    return object : PieChartTypography {
...
private fun pieChartShapes(): PieChartShapes {
    return object : PieChartShapes {
