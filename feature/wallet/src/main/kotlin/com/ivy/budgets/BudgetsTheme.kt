...
internal object BudgetsTheme {
    val colors: BudgetsColors
        @Composable
        @ReadOnlyComposable
        get() = budgetsColors(
    ...
    val typo: BudgetsTypography = budgetsTypography()
    val shapes: BudgetsShapes = budgetsShapes()
}

internal interface BudgetsColors {
    val pure: Color
...
internal interface BudgetsTypography {
    val h2: TextStyle
    val b1: TextStyle
    val b2: TextStyle
    val c: TextStyle
...
internal interface BudgetsShapes {
...
private fun budgetsColors(
    theme: Theme,
    isDarkModeEnabled: Boolean,
): BudgetsColors {
    return when (theme) {
        Theme.LIGHT -> object : BudgetsColors {
        ...
        Theme.DARK -> object : BudgetsColors {
        ...
        Theme.AMOLED_DARK -> object : BudgetsColors {
        ...
        Theme.AUTO -> if (isDarkModeEnabled) {
            budgetsColors(Theme.DARK, true)
        } else {
            budgetsColors(Theme.LIGHT, false)
        }
    }
}

private fun budgetsTypography(): BudgetsTypography {
    ...
    return object : BudgetsTypography {
...
private fun budgetsShapes(): BudgetsShapes {
    return object : BudgetsShapes {
