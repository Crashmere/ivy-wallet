...
data class ReportScreenState(
    ...
    val upcomingTransactions: ImmutableList<com.ivy.data.model.legacy.Transaction> = persistentListOf(),
    val overdueTransactions: ImmutableList<com.ivy.data.model.legacy.Transaction> = persistentListOf(),
    ...
    val transactions: ImmutableList<com.ivy.data.model.legacy.Transaction> = persistentListOf(),
